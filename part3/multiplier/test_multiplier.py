...
def test_each(simulator, test_name, width_p):
    ...
    runner(simulator, timescale, tbpath, parameters, testname=test_name, pymodule="test_multiplier")
...
def test_all(simulator, width_p):
    ...
    parameters = dict(locals())
    del parameters['simulator']
    runner(simulator, timescale, tbpath, parameters, pymodule="test_multiplier")
